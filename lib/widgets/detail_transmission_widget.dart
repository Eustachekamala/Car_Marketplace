...
class DetailTransmissionWidget extends StatelessWidget {
  final IconData icon;
  final CarModel carModel;
  const DetailTransmissionWidget({super.key, required this.icon, required this.carModel});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const SizedBox(height: 10),
        Text(carModel.transmission ?? '', style: TextStyle(
          fontSize: 16,
          fontWeight: FontWeight.w800,
          color: Colors.white
        ),),
