...
class DetailHighwayWidget extends StatelessWidget {
  final IconData icon;
  final CarModel carModel;
  const DetailHighwayWidget({super.key, required this.icon, required this.carModel});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const SizedBox(height: 10),
        Text(carModel.highway ?? '', style: TextStyle(
          fontSize: 16,
          fontWeight: FontWeight.w800,
          color: Colors.white
        ),),
